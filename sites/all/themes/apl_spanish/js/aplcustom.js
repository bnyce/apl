...
$("div.searchOptions input").change(function(event) {
	...
	switch(searchType[1]) {
		case "articles":
//			ii.attr("placeholder", 'Busque investigaciones'); // accented characters have been problematic :(
			ii.attr("placeholder", ii_a.attr("placeholder"));
			break;
		case "catalog":
			//ii.attr("placeholder", "Busque libros");
			ii.attr("placeholder", ii_c.attr("placeholder"));
			break;
		case "site":
//			ii.attr("placeholder", "Busque sitio");
			ii.attr("placeholder", ii_s.attr("placeholder"));
			break;
	}
