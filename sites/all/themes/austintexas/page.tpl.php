...
<li class="last leaf icon-311"><a title="" href="/">311</a></li>
    ...
    <?php endif; ?>
      ...
      <div id="center"><div id="squeeze"><div class="right-corner"><div class="left-corner">
		  ...
		  <div id="content_box_top" class="round-corners"><div class="tl"><div class="tr"><div class="bl"><div class="br"><div class="content-container"><?php print render($page['content_box_top']); ?></div></div></div></div></div></div>
		  <div id="content_box_middle" class="round-corners"><div class="tl"><div class="tr"><div class="bl"><div class="br"><div class="content-container"><?php print render($page['content_box_middle']); ?></div></div></div></div></div></div>
